...
O caminho até o hospital foi silencioso. Cada curva, cada luz, cada detalhe parecia amplificar o medo que crescia dentro de mim. E então, finalmente, chegamos. Eu me apeguei a você, não queria soltá-la, e mesmo assim tive que deixar suas mãos escorregarem das minhas, entregando você a um destino que eu não podia controlar.
...
E, finalmente, aprendo que é possível seguir. Seguir carregando você em cada gesto, em cada pensamento, em cada batida do meu coração. Seguir vivendo com coragem, mesmo quando a dor insiste em me puxar para baixo. Seguir acreditando que, mesmo em meio à ausência, o amor continua a iluminar o caminho.
